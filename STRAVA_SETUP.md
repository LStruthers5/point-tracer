...
PointTracer supports Strava OAuth import. When Strava is not configured the
"Connect Strava" button is automatically hidden — Strava is entirely optional.
...
Leave all Strava variables unset to hide the Strava button entirely — safe default for v1.
...
Start the backend on port 8000, then click "Connect Strava" in the UI.
